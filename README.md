...
weatherApi-V2(version 2)

Miweather-api is a web applicaion service that render weather forecast service to user.

Technology Use
-This project is build on Nestjs, which is nodejs framework used to run TypeScript from backend (server side).

Libraries
Library uses can be found in package.json file, run and it build on ;
  -node 16.x
  -nestjs 10.x
  -npm  8.x
  

 //How to clone the project on your machine run
